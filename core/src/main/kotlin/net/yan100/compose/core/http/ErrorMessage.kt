...
class ErrorMessage private constructor() : Serializable {
  ...
  companion object {
    ...
    @JvmStatic val SERVER_ERROR: ErrorMessage = failedByErrMsg(ErrMsg._500)

    @JvmStatic val BAE_REQUEST: ErrorMessage = failedByErrMsg(ErrMsg._400)

    @JvmStatic val UNKNOWN_ERROR: ErrorMessage = failedByErrMsg(ErrMsg.UNKNOWN_ERROR)
