...
@JvmOverloads
constructor(
  private val workId: Long = 1,
  private val datacenterId: Long = 2,
  private var sequence: Long = 3,
  private val startTimeStamp: Long = 100000L,
) : ISnowflakeGenerator {
  ...
  companion object {
    ...
    private val TIMESTAMP_LEFT_SHIFT =
