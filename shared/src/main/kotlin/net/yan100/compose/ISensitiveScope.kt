...
interface ISensitiveScope<T> {
  ...
  fun String.bankCard() =
    SensitiveStrategy.BANK_CARD_CODE.desensitizeSerializer()(this)

  fun String.chinaName() = SensitiveStrategy.NAME.desensitizeSerializer()(this)

  fun String.multipleName() =
    SensitiveStrategy.MULTIPLE_NAME.desensitizeSerializer()(this)

  fun String.chinaIdCard() =
    SensitiveStrategy.ID_CARD.desensitizeSerializer()(this)

  fun String.chinaPhone() =
    SensitiveStrategy.PHONE.desensitizeSerializer()(this)

  fun String.password() =
    SensitiveStrategy.PASSWORD.desensitizeSerializer()(this)
