 ...
 *
 * This interface extends [IAnyTyping] to provide type-safe handling of enums that use integer values as their underlying representation. It's the most common
 ...
 * enum class UserStatus(private val code: Int) : IIntTyping {
 ...
 * @see IStringTyping for string-based enums
 * @author TrueNine
 * @since 2023-05-28
 */
interface IIntTyping : IAnyTyping {
  /**
   * The integer value of this enum constant.
   *
   * This property narrows the type from [IAnyTyping.value] to ensure that integer-based enums always return integer values. This enables type-safe arithmetic
  ...
  companion object {
     ...
     */
    @JvmStatic operator fun get(v: Int?): IIntTyping? = null
  }
}
