...
import io.github.truenine.composeserver.systemSeparator
import java.io.File
...
class ResourceHolder(private val home: ApplicationHome, private val resourceLoader: ResourceLoader, private val p: DataLoadProperties) {
  init {
