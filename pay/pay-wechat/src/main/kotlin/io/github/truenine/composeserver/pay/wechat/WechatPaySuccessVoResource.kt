...
data class WechatPaySuccessVoResource(
  @Schema(title = "Encryption algorithm type", description = "Algorithm used to encrypt the result data; currently only AEAD_AES_256_GCM is supported") var algorithm: String? = null,
  ...
  @Schema(title = "Original type", description = "Original callback type, typically 'transaction'") @JsonProperty("original_type") var originalType: String? = null,
