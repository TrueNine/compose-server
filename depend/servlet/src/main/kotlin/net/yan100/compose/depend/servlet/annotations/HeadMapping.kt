 ...
 * - see also
 *   [RFC HTTP protocol Method HEAD](https://www.rfc-editor.org/rfc/rfc7231#section-4.3.2)
 * - see also
 *   [MDN HTTP HEAD Method](https://developer.mozilla.org/zh-CN/docs/Web/HTTP/Methods/HEAD)
 *
