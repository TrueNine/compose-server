...
class MqttPahoClientWrapper(
  private val client: IMqttClient, private val options: MqttConnectOptions, private val objectMapper: ObjectMapper
) : Closeable {
  ...
  private val mapper: ObjectMapper get() = objectMapper
...
inline fun <reified T : Any> MqttPahoClientWrapper.subscribe(
  topic: String, qos: Int = 0, noinline callback: (callbackTopic: String, message: T) -> Unit
) {
