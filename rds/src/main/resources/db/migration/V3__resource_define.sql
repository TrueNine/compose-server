...
(
  63
) DEFAULT NULL COMMENT '请求协议',
  INDEX
(
  permissions_id
) COMMENT '外联 permissions id'
...
(
  1023
) DEFAULT NULL COMMENT '请求 ip',
  resp_code CHAR
(
  63
) DEFAULT NULL COMMENT '响应码',
...
(
  1023
) NOT NULL COMMENT '资源路径名称',
  doc VARCHAR
(
  1023
) DEFAULT '' COMMENT '资源路径描述',
