...
public class AttachmentLocationEntity extends BaseEntity implements Serializable {
  ...
  @Column(table = TABLE_NAME, name = BASE_URL, nullable = false)
  private String baseUrl;

  /**
   * 资源路径名称
   */
  @Schema(name = NAME, description = "资源路径名称")
  @Column(table = TABLE_NAME, name = NAME, nullable = false)
  private String name;

  /**
   * 资源路径描述
   */
  @Schema(name = DOC, description = "资源路径描述")
   ...
   * 存储类别
   */
  @Schema(name = TYPE, description = "存储类别")
  @Column(table = TABLE_NAME, name = TYPE, nullable = false)
