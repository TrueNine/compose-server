...
abstract class SuperIdcard2 : IIdcard2Code, IEntity() {
  ...
  @Schema(title = "用户信息") @Col(name = USER_INFO_ID) var userInfoId: RefId? = null

  @Schema(title = "签发机构") @Column(name = ISSUE_ORGAN) var issueOrgan: String? = null

  @Schema(title = "身份证过期时间") @Column(name = EXPIRE_DATE) var expireDate: datetime? = null
  ...
  @Schema(title = "外联 用户（所属用户）") @Column(name = USER_ID) var userId: ReferenceId? = null
