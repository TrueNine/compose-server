...
class PostAttachmentDescriptionDto : PostAttachmentDto() {
  @Schema(title = "附件大小") var size: Long? = null

  @Schema(title = "存根在系统内的描述符", description = "通常为序列值") var metaName: String? = null

  @Schema(title = "附件类型", description = "通常在默认情况下为 二进制文件") var mimeType: MediaTypes? = null
}
