...
@Component @Converter class BloodTypingConverter : AttributeConverter<BloodTyping?, Int?> by intTyping(BloodTyping::findVal)

@Component @Converter class CertContentTypingConverter : AttributeConverter<CertContentTyping?, Int?> by intTyping(CertContentTyping::findVal)

@Component @Converter class CertPointTypingConverter : AttributeConverter<CertPointTyping?, Int?> by intTyping(CertPointTyping::findVal)

@Component @Converter class CertTypingConverter : AttributeConverter<CertTyping?, Int?> by intTyping(CertTyping::findVal)

@Component @Converter class DegreeTypingConverter : AttributeConverter<DegreeTyping?, Int?> by intTyping(DegreeTyping::findVal)

@Converter @Component class DisTypingConverter : AttributeConverter<DisTyping?, Int?> by intTyping(DisTyping::findVal)
