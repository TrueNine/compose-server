...
@MappedSuperclass
open class SuperAttachmentEntity : net.yan100.compose.rds.base.BaseEntity() {
...
@MappedSuperclass
open class SuperAttachmentLocationEntity : net.yan100.compose.rds.base.BaseEntity() {
  /**
   * 基本url
   */
  @Schema(title = "基本url")
