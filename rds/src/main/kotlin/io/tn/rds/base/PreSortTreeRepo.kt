...
import io.tn.rds.base.PreSortTreeDao
...
interface PreSortTreeRepo<T : io.tn.rds.base.PreSortTreeDao, ID : Serializable> :
  BaseRepo<T, ID> {
  @Query(
    """
    from #{#entityName} c
  ...
  fun <P : io.tn.rds.base.PreSortTreeDao> saveChildren(t: T, p: P): T? = run {
