...
abstract class BaseController<T : BaseEntity>(
  ...
  @ResponseBody
  @GetMapping("meta/all")
  @Operation(summary = "【META】分页查询所有数据")
  ...
  @Operation(
    summary = "【META】保存一组数据", description = """
  ...
  @Operation(
    summary = "【META】根据实体id修改数据", description = """
    调用该接口，传入的实体必须存在id
  """
  )
  ...
  @Operation(
    summary = "【META】根据实体id修改全部数据", description = """
    调用该接口，传入的每个实体必须存在id
  """
  )
