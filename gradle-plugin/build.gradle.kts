...
gradlePlugin {
  plugins {
    register("${libs.versions.compose.group.get()}.${project.name}") {
      ...
      displayName = "${libs.versions.compose.group.get()}.${project.name}.gradle.plugin"
      implementationClass = "${libs.versions.compose.group.get()}.gradleplugin.Main"
    ...
    register("${libs.versions.compose.group.get()}.settings-${project.name}") {
      ...
      displayName = "${libs.versions.compose.group.get()}.settings-${project.name}.gradle.plugin"
      implementationClass = "${libs.versions.compose.group.get()}.gradleplugin.SettingsMain"
