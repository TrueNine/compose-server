 ...
 */
abstract class KotlinToTypescriptInterceptor : Interceptor<ClientType, TsScope, KtToTsContext> {
  override val executeStage: Interceptor.ExecuteStage = Interceptor.ExecuteStage.LINK_ALWAYS
