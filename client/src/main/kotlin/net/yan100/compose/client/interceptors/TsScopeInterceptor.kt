...
abstract class TsScopeInterceptor :
  Interceptor<ClientType, TsScope<*>, KtToTsContext> {
  ...
  override fun defaultProcess(ctx: KtToTsContext, source: ClientType) =
    TsScope.TypeVal(meta = source, definition = TsTypeVal.Never)
}
