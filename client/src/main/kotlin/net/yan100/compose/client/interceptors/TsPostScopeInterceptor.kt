...
abstract class TsPostScopeInterceptor : Interceptor<Pair<ClientType, TsScope<*>>, TsScope<*>, KtToTsContext> {
  override val executeStage: ExecuteStage = ExecuteStage.RESOLVE_TS_SCOPE_ALWAYS
  override fun defaultProcess(ctx: KtToTsContext, source: Pair<ClientType, TsScope<*>>) = TsScope.TypeVal(
    meta = source.first,
