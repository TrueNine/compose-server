package io.github.truenine.composeserver.security.oauth2.schedule
...
@EnableAsync
@EnableScheduling
class GetAccessTokenSchedule(private val ctx: ApplicationContext, @Lazy private val api: IWxpaWebClient) {
  init {
