 ...
 */
@Service
class WxpaService(private val client: IWxpaWebClient, private val property: WxpaProperty) {
  data class WxpaVerifyDto(var preValidToken: String, var timestamp: Int, var nonce: String, var signature: String, var echostr: String)
   ...
   */
  fun fetchJsApiSignature(encodedUrl: String, nonceString: String?): WxpaProperty.WxpaSignatureResp {
  ...
  fun fetchUserInfoByAccessToken(jsCode: String): IWxpaWebClient.WxpaWebsiteUserInfoResp? {
    ...
    val codeToken = client.getWebsiteAccessToken(property.appId!!, property.appSecret!!, jsCode)
