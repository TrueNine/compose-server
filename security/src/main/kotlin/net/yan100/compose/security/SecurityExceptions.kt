...
open class JwtException(msg: String? = "安全令牌异常", meta: Throwable? = null, code: Int? = HttpErrorStatus._403.code) : SecurityException(msg, meta, code)

open class JwtExpireException(msg: String? = "token已过期", meta: Throwable? = null, code: Int? = HttpErrorStatus._401.code) : JwtException(msg, meta, code)
