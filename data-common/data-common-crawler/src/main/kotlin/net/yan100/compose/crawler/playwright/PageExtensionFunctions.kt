...
fun Page.locatorWaitFor(
    selector: String, locatorOptions: Page.LocatorOptions? = null, waitForOptions: WaitForOptions? = WaitForOptions().setState(WaitForSelectorState.ATTACHED)
): Locator {
