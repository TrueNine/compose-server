...
class TestEnvironmentPostProcessorTest {
  ...
  private lateinit var postProcessor: net.yan100.compose.testtoolkit.autoconfig.TestEnvironmentPostProcessor
  private lateinit var mockEnvironment: ConfigurableEnvironment

  @BeforeEach
  fun setUp() {
    log.trace("initializing test environment post processor test")
    postProcessor = net.yan100.compose.testtoolkit.autoconfig.TestEnvironmentPostProcessor()
