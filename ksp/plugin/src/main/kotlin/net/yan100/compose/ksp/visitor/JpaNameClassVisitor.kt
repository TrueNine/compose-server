          ...
          if (listenerSpec != null) builder.addAnnotation(listenerSpec)
            ...
            builder.addAnnotation(
              AnnotationSpec.builder(
                ...
                .addMember(
                  "%T::class",
                  Libs.net.yan100.compose.rds.core.listeners
          ...
          if (fieldAndAnnotations.isNotEmpty()) {
            ...
            builder.addFunction(
              FunSpec.builder("getId")
                ...
                .addStatement(
                  "return if (%L == net.yan100.compose.core.getDefaultNullableId()) null else %L",
                  internalIdName,
                  internalIdName,
                )
                .addAnnotation(idColumnAnnotation.build())
            ...
            builder.addFunction(
              FunSpec.builder("isNew")
                ...
                .addStatement(
                  "return %L == null || %L == net.yan100.compose.core.getDefaultNullableId()",
                  internalIdName,
                  internalIdName,
                )
            ...
            builder.addFunction(
              FunSpec.builder("equals")
                ...
                return if (null == other) false
                  ...
                  Libs.org.hibernate.Hibernate.toClassName(),
                  Libs.net.yan100.compose.rds.core.entities.IJpaPersistentEntity
                    .toClassName(),
                )
                .returns(Boolean::class)
                .build()
