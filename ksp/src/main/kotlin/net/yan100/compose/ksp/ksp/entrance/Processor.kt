 ...
 */
package net.yan100.compose.ksp.ksp.entrance

import com.google.devtools.ksp.processing.*
import com.google.devtools.ksp.symbol.KSAnnotated
import net.yan100.compose.ksp.ksp.data.ContextData
import net.yan100.compose.ksp.ksp.visitor.allClassVisitor
  ...
  override fun process(resolver: Resolver): List<KSAnnotated> {
    ...
    allFiles.forEach { f ->
      allClassVisitor.forEach {
        val ctx = ContextData(environment, resolver, codeGenerator, logger, f)
        f.accept(it, ctx)
      }
    }
