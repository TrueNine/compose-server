    ...
    object yan100 {
      object compose {
        object meta {
          object annotations {
            object client {
              ...
              val ApiIgnore = ClassDefine(
                "net.yan100.compose.meta.annotations.client",
                "ApiIgnore",
              )
              val ApiGeneratingAll = ClassDefine(
                "net.yan100.compose.meta.annotations.client",
                "ApiGeneratingAll",
              )
            }

            val MetaSkipGeneration = ClassDefine(
        ...
        object rds {
          ...
          object listeners {
            val BizCodeInsertListener = ClassDefine(
              "net.yan100.compose.rds.listeners",
              "BizCodeInsertListener",
            )
            val SnowflakeIdInsertListener = ClassDefine(
              "net.yan100.compose.rds.listeners",
          ...
          object entities {
            val IJpaPersistentEntity = ClassDefine(
  ...
  object org {
    ...
    object springframework {
      object web {
        object bind {
          object annotations {
            val RequestMapping = ClassDefine(
              "org.springframework.web.bind.annotation",
              "RequestMapping",
            )
            val Controller = ClassDefine(
              "org.springframework.web.bind.annotation",
              "Controller",
            )
            val RestController = ClassDefine(
              "org.springframework.web.bind.annotation",
              "RestController",
            )
            val GetMapping = ClassDefine(
              "org.springframework.web.bind.annotation",
              "GetMapping",
            )
            val PostMapping = ClassDefine(
              "org.springframework.web.bind.annotation",
              "PostMapping",
            )
            val PutMapping = ClassDefine(
              "org.springframework.web.bind.annotation",
              "PutMapping",
            )
            val DeleteMapping = ClassDefine(
              "org.springframework.web.bind.annotation",
              "DeleteMapping",
            )
            val PatchMapping = ClassDefine(
              "org.springframework.web.bind.annotation",
              "PatchMapping",
            )
            val RequestBody = ClassDefine(
              "org.springframework.web.bind.annotation",
              "RequestBody",
            )
            val RequestParam = ClassDefine(
              "org.springframework.web.bind.annotation",
              "RequestParam",
            )
            val PathVariable = ClassDefine(
              "org.springframework.web.bind.annotation",
              "PathVariable",
            )
            val RequestHeader = ClassDefine(
              "org.springframework.web.bind.annotation",
              "RequestHeader",
            )
            val RequestPart = ClassDefine(
              "org.springframework.web.bind.annotation",
              "RequestPart",
            )
          }
